...
import type { Post } from '@/app/_lib/get-posts'
...
function Views({ id, mutate, defaultValue }) {
  ...
  // only do it once, since the page refreshes regularly thanks to swr,
  // `useEffect` is not enough
  const didLogViewRef = useRef(false)

  useEffect(() => {
    // it's safe to do it in development since Redis is mocked
